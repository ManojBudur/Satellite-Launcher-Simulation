...
void page()
{
	...
	glVertex2d(75, 425);
	glEnd();
    drawstring(150, 450, "BITM ENGINEERING COLLEGE");
	drawstring(100, 400, "Satellite Launching Simulation MADE BY:");

	drawstring(150, 360, "Manoj Budur (3BR19CS084) ");
	drawstring(150, 340, "Manu B (3br19CS085)");


	drawstring(150, 280, "SEM : VI");
